...
/**
 * Pre-built plant templates. The AI Plant Builder matches a student's
 * spoken request against these templates by keyword, then loads the
 * corresponding layout into the 3D scene.
 *
 * Coordinates are in metres on an X-Z ground plane, Y up. Equipment is
 * laid out left-to-right along the X axis following the process flow so
 * that "walk through the plant" follows the chemistry.
 */
...
export const PLANT_TEMPLATES: PlantTemplate[] = [
  // ───────────────────────────── AMMONIA ─────────────────────────────
  {
    ...
    equipment: [
      ...
      },
      {
        id: "nh3-compressor",
        type: "compressor",
        name: "Synthesis Gas Compressor K-101",
        position: [-7, 0, 0],
        context: "Raises the synthesis gas from near-atmospheric to roughly 150 bar, the pressure required by the converter.",
      },
      {
        id: "nh3-feedheater",
        type: "heatExchanger",
        ...
        position: [-2, 0, 0],
        context: "Recovers heat from the hot reactor effluent to preheat the cold feed going into the converter — the classic energy-integration step.",
      },
      {
        id: "nh3-reactor",
        type: "reactor",
        ...
        position: [3, 0, 0],
        context: "Fixed-bed catalytic reactor containing iron catalyst. Exothermic reaction: N₂ + 3 H₂ ⇌ 2 NH₃. Per-pass conversion is only ~15–25%, so the unreacted gas is recycled.",
      },
      {
        id: "nh3-cooler",
        type: "cooler",
        ...
        position: [8, 0, 0],
        context: "Cools the reactor effluent so that the ammonia condenses to liquid while the unreacted N₂/H₂ stays gaseous.",
      },
      {
        id: "nh3-separator",
        type: "separator",
        ...
        position: [12, 0, 0],
        context: "Gravity separator that splits liquid ammonia (bottom) from the unreacted recycle gas (top). The gas returns to the compressor; the liquid ammonia goes to storage.",
      },
      {
        id: "nh3-storage",
        type: "storageTank",
        ...
        position: [16, 0, 0],
        context: "Refrigerated atmospheric tank storing liquid ammonia before dispatch to fertiliser production.",
      },
    ],
    pipes: [
      { id: "nh3-p1", from: "nh3-feed-tank", to: "nh3-compressor", stream: "feed", label: "Syngas" },
      { id: "nh3-p2", from: "nh3-compressor", to: "nh3-feedheater", stream: "intermediate", label: "150 bar syngas" },
      { id: "nh3-p3", from: "nh3-feedheater", to: "nh3-reactor", stream: "intermediate", label: "Preheated feed" },
      { id: "nh3-p4", from: "nh3-reactor", to: "nh3-feedheater", stream: "product", label: "Hot effluent" },
      { id: "nh3-p5", from: "nh3-feedheater", to: "nh3-cooler", stream: "product", label: "Cooled effluent" },
    ...
    processSteps: [
      {
        order: 1,
        title: "Feed storage",
        description: "The stoichiometric 3:1 H₂/N₂ synthesis gas is held in the feed tank, ready to enter the loop.",
        equipmentId: "nh3-feed-tank",
      },
      {
        order: 2,
        title: "Compression",
        description: "The syngas compressor raises the gas to the ~150 bar the converter needs.",
        equipmentId: "nh3-compressor",
      },
      {
        order: 3,
        title: "Feed preheat",
        description: "The cold high-pressure feed recovers heat from the hot reactor effluent in the feed/effluent exchanger — classic energy integration.",
        equipmentId: "nh3-feedheater",
      },
      {
        order: 4,
        title: "Reaction",
        description: "In the converter, N₂ and H₂ combine exothermically over iron catalyst to form ammonia. Per-pass conversion is modest, so the unreacted gas is recycled.",
        equipmentId: "nh3-reactor",
      },
      {
        order: 5,
        title: "Cooling",
        description: "The effluent is cooled further in the condenser so that the ammonia liquefies while the unreacted gas stays in vapour form.",
        equipmentId: "nh3-cooler",
      },
      {
        order: 6,
        title: "Separation",
        description: "The separator splits the two-phase stream: liquid ammonia drops to the bottom, recycle gas rises to the top.",
        equipmentId: "nh3-separator",
      },
      {
        order: 7,
        title: "Storage",
        description: "Liquid ammonia is sent to the refrigerated storage tank to await dispatch.",
        equipmentId: "nh3-storage",
      },
    ],
  },
  ...
  // ─────────────────────────── DISTILLATION ───────────────────────────
  {
    ...
    equipment: [
      {
        ...
        name: "Feed Tank",
        position: [-12, 0, 0],
        context: "Holds the binary feed mixture (e.g. methanol/water) at ambient temperature before it is pumped to the column.",
      },
      {
        id: "dist-pump",
        type: "pump",
        ...
        position: [-8, 0, 0],
        context: "Pumps the feed from the tank through the preheater and into the column at the feed tray.",
      },
      {
        id: "dist-preheater",
        type: "heatExchanger",
        ...
        position: [-4, 0, 0],
        context: "Preheats the feed close to its bubble point so that it enters the column on the right tray with minimal thermal disturbance.",
      },
      {
        id: "dist-column",
        type: "column",
        ...
        position: [1, 0, 0],
        context: "Tray column with rectifying section above the feed and stripping section below. Vapour rises, liquid falls, and the more volatile component is concentrated at the top.",
      },
      {
        id: "dist-condenser",
        type: "cooler",
        ...
        position: [6, 3, 0],
        context: "Condenses the overhead vapour using cooling water. Part of the condensate is returned as reflux, the rest withdrawn as distillate product.",
      },
      {
        id: "dist-reboiler",
        type: "heatExchanger",
        name: "Reboiler E-103",
        position: [6, -1.5, 0],
        context: "Vaporises part of the bottom liquid using steam. The generated vapour drives the stripping section.",
      },
      {
    ...
    pipes: [
      ...
      { id: "dist-p2", from: "dist-pump", to: "dist-preheater", stream: "feed", label: "Pressurised feed" },
      ...
      { id: "dist-p7", from: "dist-reboiler", to: "dist-bottoms-tank", stream: "product", label: "Bottoms product" },
    ],
    processOverview:
    ...
    processSteps: [
      ...
      { order: 3, title: "Preheat", description: "The preheater warms the feed close to its bubble point so it enters the column thermally matched.", equipmentId: "dist-preheater" },
  ...
  // ─────────────────────────── SULFURIC ACID ───────────────────────────
  {
    ...
    equipment: [
      ...
      },
      {
        ...
        position: [-3, 0, 0],
        context: "Multi-bed catalytic converter with vanadium pentoxide catalyst. Exothermic: 2 SO₂ + O₂ → 2 SO₃. Inter-bed cooling controls temperature.",
      },
      {
        id: "h2so4-economiser",
        type: "heatExchanger",
        ...
        position: [2, 0, 0],
        context: "Recovers heat from the converter effluent to preheat the incoming SO₂ gas — energy integration between beds.",
      },
      {
        id: "h2so4-absorber",
        type: "column",
        ...
        position: [7, 0, 0],
        context: "Packed tower in which concentrated sulfuric acid absorbs SO₃ to form oleum, later diluted to product acid.",
      },
      {
        id: "h2so4-cooler",
        type: "cooler",
        ...
        position: [11, 0, 0],
        context: "Removes the heat of absorption from the circulating acid stream before it returns to the tower.",
      },
      {
        id: "h2so4-product",
        type: "storageTank",
  ...
  // ─────────────────────────── ETHANOL ───────────────────────────
  {
    ...
    equipment: [
      ...
      },
      {
        ...
        position: [-4, 0, 0],
        context: "Stirred batch fermenter. Yeast converts glucose to ethanol and CO₂: C₆H₁₂O₆ → 2 C₂H₅OH + 2 CO₂. Temperature controlled at ~32 °C.",
      },
      {
        id: "etoh-beer-column",
        type: "column",
        ...
        position: [1, 0, 0],
        context: "Strips ethanol from the fermentation broth (the 'beer'), producing a dilute ethanol overhead and a stillage bottom.",
      },
      {
        id: "etoh-rectifier",
        type: "column",
        ...
        position: [6, 0, 0],
        context: "Concentrates the dilute ethanol up to the azeotropic ~95.6% limit. Further dehydration (molecular sieves) would produce anhydrous ethanol.",
      },
      {
        id: "etoh-condenser",
        type: "cooler",
        ...
        position: [10, 3, 0],
        context: "Condenses the rectifier overhead using cooling water; reflux returns to the column, product is withdrawn.",
      },
      {
        id: "etoh-cooler",
        type: "cooler",
    ...
    pipes: [
      ...
      { id: "etoh-p2", from: "etoh-pump", to: "etoh-fermenter", stream: "feed", label: "Feed to fermenter" },
